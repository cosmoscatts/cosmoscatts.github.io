...
<template>
  <Layout class="post">
    ...
    <div prose prose-lg mt-6 mb-8 mx-a>
      <h1 text-4xl font-bold slide-enter>
        {{ title }}
      </h1>
      <p class="op-50 mt-2 slide-enter">
    ...
    <footer prose-lg mx-auto mt-16 slide-enter animate-delay-500>
      <div class="grid md:grid-cols-2 pb-3 text-[0.95em]">
        ...
        <span md:text-right text-c-light>
          <span class="i-ic:round-update w-4.5 h-4.5" />
          {{ lastUpdatedText }}
          {{ lastUpdated }}
        </span>
      </div>
