...
import { type Author, Feed, type FeedOptions } from 'feed'
...
function resolveOptions(options: RSSOptions) {
...
async function getBlogs(sourceDir: string, exclude?: string[]) {
...
async function generate(options: RSSOptions) {
...
export async function generateRSS(options: RSSOptions) {
