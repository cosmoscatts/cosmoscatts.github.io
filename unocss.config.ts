...
export default defineConfig({
  shortcuts: [
    ...
    ['nav-item', 'flex items-center space-x-1 text-c-light hover:text-c-dark'],
    [
      'btn',
      'flex items-center space-x-1 rounded transition-colors decoration-none text-sm !text-c bg-gray-100/90 dark:bg-gray-50/10 hover:(!bg-gray-500 !text-white !no-underline)',
    ],
